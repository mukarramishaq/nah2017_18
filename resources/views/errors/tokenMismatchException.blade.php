<html><head>
  ...
  <title>404 Not Found | NUST Alumni Homecoming</title>
...
<section class="content">
      <div class="error-page">
        ...
        <div class="error-content">
          <h3><i class="fa fa-warning text-yellow"></i> Oops! Your token for this page has expired. In future, relaod the page if it has been open for atleast one hour.</h3>
